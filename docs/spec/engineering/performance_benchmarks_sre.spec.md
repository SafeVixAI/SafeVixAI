...
> **Cross-references:** [SCALING_GUIDE.md](../../sre/scaling_guide.md), [MONITORING_SETUP.md](metrics.spec.md)
...
- [BENCHMARKS.md](performance_benchmarks.spec.md) — Performance benchmarks overview
- [MONITORING.md](../../sre/monitoring_overview.md) — Metrics dashboards and uptime monitoring
- [SCALING_GUIDE.md](../../sre/scaling_guide.md) — Horizontal scaling and caching
