...
> **Cross-references:** [observability index](../../sre/observability.md), [ADVANCED_SETUP.md](../../sre/advanced_setup.md)
...
- High error rate → [runbooks/high-error-rate.md](../../runbooks/RB-004-high-error-rate.md)

## Related

- [MONITORING.md](../../sre/monitoring_overview.md) — Monitoring overview and dashboards
- [OBSERVABILITY.md](../../sre/observability.md) — Observability architecture
- [OPERATIONS.md](../../sre/operations_manual.md) — Operations and incident response
- [TELEMETRY.md](../security/telemetry_privacy.spec.md) — Telemetry configuration and data collection
