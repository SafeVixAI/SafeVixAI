...
jest.mock('@/lib/api/update-api', function() { return { fetchUpdateSettings: function() { return Promise.resolve({ auto_update_enabled: true, background_download: true, auto_restart: false, notify_on_update: true, retry_on_failure: true, channel: 'stable', schedule: 'immediate', gpg_public_key: null }) }, fetchChannels: function() { return Promise.resolve([]) }, fetchUpdateHistory: function() { return Promise.resolve({ installations: [] }) }, updateUpdateSettings: function() { return Promise.resolve({ auto_update_enabled: true, background_download: true, auto_restart: false, notify_on_update: true, retry_on_failure: true, channel: 'stable', schedule: 'immediate', gpg_public_key: null }) }, updatePublicKey: function() { return Promise.resolve({ auto_update_enabled: true, background_download: true, auto_restart: false, notify_on_update: true, retry_on_failure: true, channel: 'stable', schedule: 'immediate', gpg_public_key: null }) }, restartApplication: function() { return Promise.resolve() }, subscribeToDownloadProgress: function() { return function() {} }, retryOperation: function() { return Promise.resolve() }, checkForUpdates: function() { return Promise.resolve({ latest_version: '1.1.0', update_available: true, is_mandatory: false, is_security: false, last_checked_at: null, current_version: '1.0.0' }) } } })
