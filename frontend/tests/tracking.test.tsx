...
jest.mock('@/lib/store', function() { return { useAppStore: Object.assign(function(sel) { const state = { gpsLocation: null, userProfile: {}, authToken: null }; return typeof sel === 'function' ? sel(state) : state }, { getState: function() { return {} }, setState: jest.fn(), subscribe: jest.fn() }) } })
...
const TrackingPage = require('../app/tracking/page').default
...
describe('TrackingPage', function() {
  it('renders Join Tracking Group heading when idle', function() {
    const { container } = render(React.createElement(TrackingPage))
