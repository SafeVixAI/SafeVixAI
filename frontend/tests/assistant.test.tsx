...
jest.mock('next/dynamic', function() { return function() { return function() { const r = require('react'); return r.createElement('div', null, r.createElement('textarea')) } } })
...
jest.mock('@/lib/store', function() {
  const state = { aiMode: 'online', setAiMode: jest.fn(), setModelLoadProgress: jest.fn() }
...
const ChatPage = require('../app/assistant/page').default

describe('Assistant Page', function() {
  it('renders AI Assistant sr-only heading', function() {
    const { getByText } = render(React.createElement(ChatPage))
