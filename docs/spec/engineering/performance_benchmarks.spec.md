...
|----------|-------------|
| [`docs/PERFORMANCE_BENCHMARKS.md`](performance_benchmarks_sre.spec.md) | Detailed latency, throughput, resource benchmarks |
...
See [`docs/PERFORMANCE_BENCHMARKS.md`](performance_benchmarks_sre.spec.md) for historical benchmark data and regression tracking.

---

## Related

- [`docs/MONITORING_SETUP.md`](metrics.spec.md) — production monitoring
