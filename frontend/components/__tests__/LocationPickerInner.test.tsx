...
const markerCallbacks: Record<string, Function> = {}
...
describe('LocationPickerInner', function () {
  ...
  it('renders map container and address display', async function () {
    const LocationPickerInner = (await import('../report/LocationPickerInner')).default
  ...
  it('recenters on user location via geolocation', async function () {
    const getCurrentPosition = jest.fn(function (success) {
