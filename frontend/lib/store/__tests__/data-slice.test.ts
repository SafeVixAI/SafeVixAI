...
const CrashDetectionModule = require('@/lib/crash-detection')
...
describe('DataSlice', function() {
  ...
  it('setNearbyServices updates services', function() {
    const store = createTestStore()
    const services = [{ id: '1', name: 'Hospital A', category: 'hospital', lat: 13.0, lng: 80.0, distance: 500, phone: '123' }]
  ...
  it('setChallanState updates challan state', function() {
    ...
    const cs = store.getState().challanState
  ...
  it('setGarageVehicles sets vehicles', function() {
    const store = createTestStore()
    const vehicles = [{ id: 'v1', plate: 'TN01AB1234' }]
  ...
  it('setNearbyRoadIssues updates road issues', function() {
    const store = createTestStore()
    const issues = [{ id: 'r1', type: 'pothole', lat: 13.0, lng: 80.0, description: 'Big pothole' }]
  ...
  it('setRiskAnalysis updates risk data', function() {
    ...
    const ra = store.getState().riskAnalysis
