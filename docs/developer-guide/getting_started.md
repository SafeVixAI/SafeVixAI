...
*For full deployment to Vercel + Render.com, see [`docs/Deployment.md`](chatbot_deployment.md)*
*For the complete app overview, see [`docs/Agent.md`](ai_agent_guide.md)*
...
- [docs/MONITORING_SETUP.md](../spec/engineering/metrics.spec.md) — Prometheus/Grafana/Loki setup
