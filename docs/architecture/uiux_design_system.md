...
**UX Audit Score: 100/100 (Enterprise Gold Standard — aspirational target; see [docs/UX_95_PLAN.md](../archive/milestone-plans/UX_95_PLAN.md) for current measured baseline)**
...
- [SYSTEM_DESIGN.md](c4_system_design.md) — Detailed system design and component specs
- [OBSERVABILITY.md](../sre/observability.md) — Logging, metrics, tracing architecture
- [ARCHITECTURE.md](system_overview.md) — System architecture overview
- [UIUX.md](../product/uiux_product_overview.md) — User experience and interface design
