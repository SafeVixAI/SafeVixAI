...
| Area | Documentation |
|------|---------------|
| Setup Guide | [`docs/MONITORING_SETUP.md`](../spec/engineering/metrics.spec.md) |
...
| Telemetry Guide | [`docs/TELEMETRY.md`](../spec/security/telemetry_privacy.spec.md) |
| Performance Benchmarks | [`docs/PERFORMANCE_BENCHMARKS.md`](../spec/engineering/performance_benchmarks_sre.spec.md) |
...
- [`RUNBOOKS.md`](runbooks_overview.md) — incident response
