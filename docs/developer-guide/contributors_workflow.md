...
> **Cross-references:** [CONTRIBUTING.md](contributing_guide.md), [SETUP.md](getting_started.md), [STYLE_GUIDE.md](style_guide.md), [TESTING_POLICY.md](../spec/engineering/testing_policy.spec.md)
...
See [Architecture.md](chatbot_architecture.md) for system architecture and data flows.
...
See [SETUP.md](getting_started.md) for detailed setup instructions.
