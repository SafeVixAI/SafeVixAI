jest.mock('next/navigation', function() { return { useParams: function() { return { slug: 'chennai' } }, useRouter: function() { return { push: jest.fn(), back: jest.fn() } }, Link: function({ children, ...rest }) { var React = require('react'); return React.createElement('a', rest, children) } } })
...
var mockData = { slug: 'chennai', name: 'Chennai Corporation', shortName: 'Chennai', stateCode: 'TN', city: 'Chennai', municipalityType: 'municipal_corporation', wardCount: 200, population: 11000000, helplinePhone: '1913', centroidLat: 13.08, centroidLon: 80.27, areaSqkm: 426, description: 'Capital of Tamil Nadu', servicesOffered: ['Water', 'Roads'] }
