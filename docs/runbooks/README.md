...
| [RB-004: Service Degradation](RB-004-high-error-rate.md) | High latency / 5xx errors | P1 |
| [RB-005: Deployment Rollback](RB-005-rollback.md) | Failed deployment | P1 |
| [RB-006: Secrets Rotation Failure](RB-006-secret-rotation.md) | Secrets rotation failed | P2 |
| [RB-007: CI/CD Pipeline Failure](RB-010-smoke-tests.md) | CI/CD broken | P2 |
