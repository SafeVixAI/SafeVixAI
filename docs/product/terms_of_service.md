...
flowchart TB
    ...
    class AID neutral
    class Legal neutral
    class ACCURATE neutral
    class NO_MISUSE neutral
    class SECURE neutral
    class COMPLY edge```
...
Your use of the Service is governed by our [Privacy Policy](../spec/security/privacy_boundary.spec.md). Key privacy commitments:
...
- See [PRIVACY.md](../spec/security/privacy_boundary.spec.md) for full details
